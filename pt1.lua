...
-- ============================
-- ISENG V2: FLY & EXPLODE
-- ============================
local IsengV2Section = IsengTab:Section({Title = "Iseng V2: Fly & Explode"})
...
local VictimDropdownV2 = IsengV2Section:Dropdown({
...
IsengV2Section:Button({
    Title = "Refresh Player List",
    Callback = function()
        UpdatePlayerListForV2()
        VictimDropdownV2:Refresh(PlayerListForV2)
        MahiruUi:Notify({
            Title = "Iseng V2",
...
local IsengV2Toggle = IsengV2Section:Toggle({
    Title = "Fly & Explode",
...
-- ============================
-- ISENG V3: FREEZE PLAYER
-- ============================
local IsengV3Section = IsengTab:Section({Title = "Iseng V3: Freeze Player"})
...
local FreezeVictimDropdown = IsengV3Section:Dropdown({
...
local IsengV3Toggle = IsengV3Section:Toggle({
    Title = "Freeze Player",
